...
const Example1 = () => {
    useEffect(() => {
        ...
        function draw() {
            ...
            webgl.drawArrays(webgl.TRIANGLES, 0, lineArr.length / 4);
            // webgl.drawArrays(webgl.TRIANGLE_FAN, 0, lineArr.length / 4);
            // webgl.drawArrays(webgl.TRIANGLE_STRIP, 0, lineArr.length / 4);
        }
